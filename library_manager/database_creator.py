...
wrote = """CREATE TABLE IF NOT EXISTS WROTE(
    ...
    CONSTRAINT fk_WROTE_BOOK FOREIGN KEY (isbn) REFERENCES BOOK(isbn) 
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_WROTE_AUTHOR FOREIGN KEY (author_id) REFERENCES AUTHOR(author_id)
        ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB;"""
...
employee = """CREATE TABLE IF NOT EXISTS EMPLOYEE(
    ...
    CONSTRAINT fk_EMPLOYEE_USER FOREIGN KEY (email) REFERENCES USER(email)
        ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB;"""
...
borrows = """CREATE TABLE IF NOT EXISTS BORROW(
    ...
    isbn INT NOT NULL,
    PRIMARY KEY(card_number, isbn),
    CONSTRAINT fk_BORROW_MEMBER FOREIGN KEY (card_number) REFERENCES MEMBER(card_number)
        ON UPDATE CASCADE ON DELETE CASCADE,
...
holds = """CREATE TABLE IF NOT EXISTS HOLDS(
    ...
    PRIMARY KEY(card_number, isbn),
    CONSTRAINT fk_HOLDS_MEMBER FOREIGN KEY (card_number) REFERENCES MEMBER(card_number)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_HOLDS_BOOK FOREIGN KEY (isbn) REFERENCES BOOK(isbn)
        ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB;"""
...
orders = """CREATE TABLE IF NOT EXISTS ORDERS(
    ...
    CONSTRAINT fk_ORDERS_BOOK FOREIGN KEY (isbn) REFERENCES BOOK(isbn)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_ORDERS_PUBLISHER FOREIGN KEY (publisher) REFERENCES PUBLISHER(publisher_name)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_ORDERS_EMPLOYEE FOREIGN KEY (employee_num) REFERENCES EMPLOYEE(employee_num)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_ORDERS_BRANCH FOREIGN KEY (branch_num) REFERENCES BRANCH(branch_id)
        ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB;"""
...
owns = """CREATE TABLE IF NOT EXISTS OWNS(
    ...
    CONSTRAINT fk_OWNS_BOOK FOREIGN KEY (isbn) REFERENCES BOOK(isbn)
        ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT fk_OWNS_BRANCH FOREIGN KEY (branch_id) REFERENCES BRANCH(branch_id)
        ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB;"""
cursor.execute(owns)
